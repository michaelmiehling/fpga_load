...
/*!
 *         \file  _istrata_mmod_sw_stub.c
 *
 *       \author  Christian.Kauntz@men.de
 *        $Date: 2009/03/05 09:53:00 $
 *    $Revision: 2.3 $
 *
 *        \brief  instance for IntelStrata Flash swapped m-module version
 *
 *
 *     Required: -
 *    \switches  (none)
...
#define FL_SWAP_MMOD_SW
#define Z100_ISTRATAPC28FXXXP30_TRY Z100_ISTRATAPC28FXXXP30_TRY_mmod_sw
